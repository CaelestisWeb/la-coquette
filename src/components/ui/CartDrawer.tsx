          ...
          return (
            <div className="px-6 py-6 border-t border-gris space-y-4">
              ...
              <Link href="/checkout" onClick={() => setIsOpen(false)}
                className="block w-full bg-noir text-blanc border border-noir font-body font-medium tracking-widest text-xs uppercase py-4 rounded hover:bg-or transition-colors duration-300 text-center">
                Commander
              </Link>
            </div>
          );
