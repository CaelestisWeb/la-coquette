    ...
    <footer className="bg-noir text-blanc/70">
      <div className="max-w-2xl mx-auto px-6 py-20 flex flex-col items-center text-center">
        ...
        <div className="mt-9 flex flex-col sm:flex-row items-center gap-5">
          <Link
            href="/contact"
            className="inline-flex items-center font-body text-[11px] tracking-[0.22em] uppercase text-blanc border border-blanc/25 px-7 py-3.5 rounded hover:bg-creme hover:text-noir transition-colors duration-500"
          >
            Nous contacter
          </Link>
          <a
