    ...
    <section className="bg-noir py-28">
      <div className="max-w-2xl mx-auto px-6 text-center reveal">
        ...
        <Link
          ...
          className="inline-block mt-10 bg-creme text-noir font-body text-[11px] font-normal tracking-[0.22em] uppercase px-10 py-4 rounded hover:bg-creme/80 transition-colors duration-500"
        >
