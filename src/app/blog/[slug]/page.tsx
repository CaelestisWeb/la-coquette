      ...
      <div className="pt-32 md:pt-44 min-h-screen bg-ivoire">
        <article className="max-w-3xl mx-auto px-6 py-16">
          ...
          <div className="mt-14 flex flex-wrap justify-center gap-3">
            <Link href="/boutique" className="inline-flex items-center font-body text-[11px] tracking-[0.22em] uppercase bg-noir text-blanc border border-noir px-8 py-4 rounded hover:bg-taupe transition-colors duration-500">
              Découvrir les créations
            </Link>
            <Link href="/contact" className="inline-flex items-center font-body text-[11px] tracking-[0.22em] uppercase border border-noir text-noir px-8 py-4 rounded hover:border-noir transition-colors duration-500">
              Contacter Caro
            </Link>
          </div>
        </article>
    ...
    <div className="pt-32 md:pt-44 min-h-screen bg-ivoire">
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="mt-12 flex gap-4">
          <Link href="/boutique" className="inline-flex items-center font-body text-[11px] tracking-[0.22em] uppercase bg-noir text-blanc border border-noir px-7 py-3.5 rounded hover:bg-taupe transition-colors duration-500">
            Voir la boutique
          </Link>
          <Link href="/blog" className="inline-flex items-center font-body text-[11px] tracking-[0.22em] uppercase border border-noir text-noir px-7 py-3.5 rounded hover:border-noir transition-colors duration-500">
            Retour au journal
          </Link>
        </div>
      </div>
