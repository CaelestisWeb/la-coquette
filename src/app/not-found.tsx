    ...
    <div className="pt-32 md:pt-44 min-h-screen bg-ivoire flex items-center justify-center">
      <div className="text-center px-6 py-20 max-w-md">
        ...
        <div className="mt-10 flex flex-wrap gap-3 justify-center">
          <Link href="/"
            className="inline-block bg-noir text-blanc font-body text-xs font-medium tracking-widest uppercase px-8 py-3.5 rounded hover:bg-or transition-colors duration-300">
            Retour à l'accueil
          </Link>
          <Link href="/boutique"
            className="inline-block border border-or text-or font-body text-xs font-medium tracking-widest uppercase px-8 py-3.5 rounded hover:bg-or hover:text-blanc transition-colors duration-300">
            Voir la boutique
          </Link>
        </div>
      </div>
