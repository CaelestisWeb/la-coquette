...
export default function AddToCartButton({ product }: { product: Product }) {
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3">
      ...
      <div className="flex items-center border border-gris w-fit">
        <button
      ...
      <button
        ...
        className="flex-1 bg-noir text-blanc font-body font-medium text-xs tracking-widest uppercase py-4 px-8 hover:bg-or transition-colors duration-300"
      >
        Ajouter au panier
      </button>
    </div>
